...
public class conference_reviews
{
    ...
    public static void main (String args[]) {
     ...
     t.addEdge("S", "Rev_1",1 , 0);
     t.addEdge("S", "Rev_2",1 , 0);
     t.addEdge("S", "Rev_3",1 , 0);

     t.addEdge("Rev_1", "topic_1", 1, 0);
     t.addEdge("Rev_1", "topic_2", 1, 0);
     t.addEdge("Rev_2", "topic_2", 1, 0);
     t.addEdge("Rev_3", "topic_3", 1, 0);
     t.addEdge("Rev_3", "topic_4", 1, 0);
     t.addEdge("topic_1", "T", 1, 0);
     t.addEdge("topic_2", "T", 1, 0);
     t.addEdge("topic_3", "T", 1, 0);
     t.addEdge("topic_4", "T", 1, 0);
              ...
              public String toString(boolean directed) {
                if (directed) {             // Directed Graph
                  ...
                  for (String key : vertices.keySet()) {    // Record each edge by adjacency
                    ...
                    for (Edge e : edges) {
                        if(e.flow > 0){
                      s.append("\"" + e.source + "\"" + " -> " + "\"" + e.target + "\"" + " [label = \"" + e.flow + "/" + e.capacity + "\" , color = red];\n");
                  }else
                  {
                    s.append("\"" + e.source + "\"" + " -> " + "\"" + e.target + "\"" + " [label = \"" + e.flow + "/" + e.capacity + "\" , color = black];\n");
                  }
                    }
                  ...
                  for (String key : vertices.keySet()) {    // Record each edge by adjacency
                    ...
                    for (Edge e : edges) {
                      ...
                      s.append("\"" + e.source + "\"" + " -- " + "\"" + e.target + "\"" + " [label = \"" + e.weight + "\" color = black];\n");
                    }
