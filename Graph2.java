...
public class Graph2 {
    ...
    public static void main (String [] args)
    {
        ...
        t.kruskal();
         Graph2 primGraph = t.prim("A");

        System.out.println(primGraph.toString(false));      // Prim Simplified Network

        System.out.println("\nTotal Weight of FullGraph is: " + t.totalWeight());
        System.out.println("\nTotal Weight of PrimGraph is: " + primGraph.totalWeight(true));

        Graph2 krusGraph = t.kruskal();
        System.out.println(krusGraph.toString(false));      // Krusk. Simplified Network
        System.out.println("\nTotal Weight of KrusGraph is: " + krusGraph.totalWeight(true));
